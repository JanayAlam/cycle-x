    ...
    <form @submit.prevent="submitHandler">
        ...
        <div class="form-group mt-2">
            ...
            <input type="password" class="form-control" :class="{ 'is-invalid': v$.confirmPassword.$error }"
                placeholder="Retype password" aria-label="c-password" id="c-password" v-model="data.confirmPassword" />
        ...
        <button v-if="isLoading" class="mt-2 btn btn-sm btn-primary" disabled type="submit">
            <span class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span> Processing....
        </button>
        <button v-else class="mt-2 btn btn-sm btn-primary" type="submit">
